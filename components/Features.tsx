...
const FEATURES = [
  {
    ...
    icon: (
      <svg width="34" height="34" viewBox="0 0 34 34" fill="none">
        <path
          d="M17 4C17 4 8 9 8 18c0 5 4 9 9 9s9-4 9-9C26 9 17 4 17 4z"
          fill="#8B2635"
          opacity="0.12"
          stroke="#8B2635"
          strokeWidth="1.4"
  ...
  },
  {
    ...
    icon: (
      <svg width="34" height="34" viewBox="0 0 34 34" fill="none">
        ...
        />
        <path
          d="M7 17 Q11 8 17 17 Q23 26 27 17"
          stroke="#8B2635"
          strokeWidth="1.5"
          fill="none"
          strokeLinecap="round"
        />
        <path
          d="M7 20.5 L27 20.5 M7 13.5 L27 13.5"
          stroke="#D1A46E"
          strokeWidth="0.8"
          opacity="0.5"
        />
    ...
    icon: (
      <svg width="34" height="34" viewBox="0 0 34 34" fill="none">
        ...
        <rect
          ...
          fill="#8B2635"
          opacity="0.08"
          transform="rotate(-4 9 3)"
        />
        <path
          d="M9 13 L25 13 M9 17.5 L21 17.5 M9 22 L16 22"
          stroke="#8B2635"
          strokeWidth="1.5"
          opacity="0.6"
          strokeLinecap="round"
